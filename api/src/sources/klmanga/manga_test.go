...
var mangasTestTable = []mangaTestType{
	{
		expected: &manga.Manga{
			...
			CoverImgURL:     "https://klmanga.lt/wp-content/uploads/2024/04/001-100.webp",
	...
	},
	{
		expected: &manga.Manga{
			...
			CoverImgURL:     "https://klmanga.lt/wp-content/uploads/2024/03/1245784.jpg",
			CoverImgResized: true,
			LastReleasedChapter: &manga.Chapter{
				Chapter: "8",
	...
	},
	{
		expected: &manga.Manga{
			...
			CoverImgURL:     "https://klmanga.lt/wp-content/uploads/2024/04/DL-Raw.Se_0001-10.jpg",
			CoverImgResized: true,
			LastReleasedChapter: &manga.Chapter{
				Chapter: "20",
